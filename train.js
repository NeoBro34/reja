...
//     }
// }
// // 1-stepda:Call --> then/catch  methodlaridan foydalandik .then(data), .catch(err)
...
// // 2-stepda:Call --> async/await  dan foydalangan holda bir nechta so'rovlarni berishimiz mumkin
